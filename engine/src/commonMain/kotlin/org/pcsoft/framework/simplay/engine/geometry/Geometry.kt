 ...
 */
@Serializable
data class Size(val width: Double, val height: Double) : PlatformSerializable
 ...
 */
@Serializable
data class Rect(val x: Double, val y: Double, val width: Double, val height: Double) : PlatformSerializable

/**
 * The four inner offsets of a box. All values are unit-less doubles.
 */
@Serializable
data class Margins(val left: Double, val top: Double, val right: Double, val bottom: Double) : PlatformSerializable
