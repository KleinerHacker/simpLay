...
class SerializationTest {
    ...
    private val style = TextStyle(Font("Serif", 12.0, FontWeight.BOLD, FontStyle.ITALIC))
    private val layout = PageLayout(Size(210.0, 297.0), Margins(20.0, 20.0, 20.0, 20.0))
    ...
    fun roundTripsDocumentWithBothPageKinds() {
        val document = Document(
            listOf(
                FlowPage(layout, listOf(TextBlock.of("Hello, world!", style))),
                SinglePage(layout, listOf(TextBlock.of("Second page.", style))),
            ),
        )
