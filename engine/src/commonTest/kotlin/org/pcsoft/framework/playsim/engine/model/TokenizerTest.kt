...
class TokenizerTest {
    ...
    private val style: TextStyle = TextStyle(Font("Serif", 12.0))
    ...
    fun splitsPlainWords() {
        assertEquals(
            listOf(TextWord("The"), TextWord("quick"), TextWord("fox")),
            parts("The quick fox"),
        )
    }
    ...
    fun splitsTrailingPunctuation() {
        assertEquals(
            listOf(TextWord("Hello"), TextSymbol(','), TextWord("world"), TextSymbol('!')),
            parts("Hello, world!"),
        )
    }
    ...
    fun splitsHyphen() {
        assertEquals(
            listOf(TextWord("state"), TextSymbol('-'), TextWord("of"), TextSymbol('-'), TextWord("art")),
            parts("state-of-art"),
        )
    }
    ...
    fun splitsQuotes() {
        assertEquals(
            listOf(TextSymbol('"'), TextWord("hi"), TextSymbol('"')),
            parts("\"hi\""),
        )
    }
    ...
    fun treatsLineBreakAsSeparator() {
        assertEquals(listOf(TextWord("first"), TextWord("second")), parts("first\nsecond"))
    }
    ...
    fun collapsesMultipleWhitespace() {
        assertEquals(listOf(TextWord("a"), TextWord("b")), parts("a    \t  b"))
    }
