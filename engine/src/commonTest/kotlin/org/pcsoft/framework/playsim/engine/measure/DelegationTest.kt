...
import org.pcsoft.framework.playsim.engine.model.TextSymbol
import org.pcsoft.framework.playsim.engine.model.TextWord
...
class DelegationTest {
    ...
    fun measuredFontDelegatesEveryRawProperty() {
        ...
        val measured = MeasuredFont(raw, MeasureTestData.bodyMetrics)
    ...
    fun measuredTextPartForwardsText() {
        ...
        val word = MeasuredTextPart(rawWord, MeasureTestData.someRect())
        val symbol = MeasuredTextPart(TextSymbol('!'), MeasureTestData.someRect())
    ...
    fun measuredLineStoresItsOwnValues() {
        val box = Rect(x = 1.0, y = 2.0, width = 30.0, height = 12.0)
