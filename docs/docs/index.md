...
`simPLay` provides a platform-independent simulation core (`engine`) and a set of
JVM integration modules that connect a running simulation to a user interface
