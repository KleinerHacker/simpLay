...
- IP-04 Floating Overlays — `FP-003-IP-04-FloatingOverlays.md`
...
- IP-04 — benötigt IP-03; liefert die FXML-kompatible API für von außen registrierte schwebende Komponenten, die bei Selektion, Absatz-Hover und Blatt-Hover ein-/ausgeblendet und positioniert werden; erweitert den `Readonly`-Reiter um Beispiel-Overlays.
...
- IP-04, IP-05 und IP-06 bauen alle auf IP-03 auf und sind untereinander parallelisierbar.
- IP-07 kommt zuletzt.
