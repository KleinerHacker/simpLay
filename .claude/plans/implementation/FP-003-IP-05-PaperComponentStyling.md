# FP-003 / IP-05: Paper Component Styling
...
* Abstimmung mit IP-04 über die gemeinsame Skin-Klasse (Caret-/Selektionszeichnung).

## Schnittstellen zu anderen Plänen

* Verbraucht IP-03; kann sich mit der IP-04-Skin überschneiden, gemeinsame Skin-Klasse.
...
| `docs/docs/fx/implementation.md` | Nur Verweis: Styling-Seite folgt in IP-06. |
...
* Sicherstellen, dass Caret- und Selektionszeichnung (IP-04) dieselben Werte verwenden.
...
* Zusammenspiel mit IP-04 an derselben Skin-Klasse ohne Konflikte; Reihenfolge der Umsetzung.
