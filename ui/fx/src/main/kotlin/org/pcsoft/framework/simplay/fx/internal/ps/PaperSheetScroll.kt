 ...
 * target directly to the owning [org.pcsoft.framework.simplay.engine.measure.MeasuredPage] index and
 * its line's `y`, instead of reusing [PaperSheetCaret]'s `geom`, which also resolves an `x` nothing
 * here needs.
 *
